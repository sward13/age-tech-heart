...
const Navigation = () => {
  ...
  return <nav className="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-sm border-b border-border">
    <div className="container-width">
      <div className="flex items-center justify-between h-16 px-6 py-0 my-[12px]">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Button variant="default" size="sm" asChild>
            <Link to="https://docs.google.com/forms/d/e/1FAIpQLScvT4UplPtwnb1i1cgsQdTZAZiQqb_HLZSn78olNYasurD1-g/viewform" target="_blank"
              rel="noopener noreferrer">Join now</Link>
          </Button>
        </div>
